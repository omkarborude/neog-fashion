  ...
  return (
    <div className="wishlist-main-div">
      {state.itemsInWishlist.length === 0 ? (
        <h1 className="cart-title">Empty</h1>
      ) : (
        ...
        return (
          <div className="wishlist-card-div">
            ...
            <div className="wishlist-card-info-div">
              <Link to={`/${product._id}`} state={{ product }} className="Link">
                <p className="cart-info-name">{product.name}</p>
                <p className="cart-info-brand">
                  Brand: <span>{product.brand}</span>
                </p>
                <p className="cart-info-rating">
                  Rating:{" "}
                  <span>
                    {product.rating}
                ...
                <p className="cart-info-price">
                  Rs. {product.price} <span>({product.offer}%off)</span>
                </p>
              </Link>
              ...
              <button
                onClick={() => {
                  RemoveProductWishlist({ state, dispatch, product, userId });
                }}
                className="btn-movetocart"
              >
                Remove
